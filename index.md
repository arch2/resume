...
**Technologies:** TFS, GIT, Entity Framework, Angular, Angular Material, SQL Server, HTML, CSS, JavaScript, MVC, Typescript, WebAPI.
...
**Technologies:**  TFS, GIT, ADO.net Angular, SQL Server, HTML, CSS, JavaScript, Bootstrap, MVC, Typescript, WebAPI.
...
**Technologies:** TFS, GIT, nHibernate, Entity Framework, ADO.net, JQuery, SQL Server, HTML, CSS, JavaScript, Bootstrap, MVC, Typescript, WebAPI.
...
**Technologies:** Entity Framework 6.0, AngularJS, ASP.NET Web Forms, ADO.Net, SQL Server, Bootstrap.
...
**Technologies:** GIT, nHibernate,ColdFusion, RabbitMQ, SQL Server, JavaScript, Bootstrap
...
**Technologies:** ASP.NET 3.5, C# 3.0, ADO.NET, HTML, CSS, JavaScript, SQL 2005 Express, Forms Based Authentication, Validation Controls, Login Controls, and Data Controls
...
**Technologies:** Java, Git, Android Studio, Android SDK
